...
flowchart TD
    ...
    E -->|has items| I[Render events table]
    ...
    M --> O[Fill fields: title, date, endDate, allDay, location, type, description]
    N --> O
    ...
    U -->|create| V[addDoc to events]:::db
    U -->|update| W[updateDoc in events]:::db
    ...
    Z -->|no| R
    Z -->|yes| AA[deleteDoc from events]:::db
    AA --> I
